...
const MODELS = {
  ...
  deepseek: {
    ...
    tokenizer: 'exact',
    tokenizerPrecision: 'exact',
    tokenizerNote: 'Uses the official DeepSeek-V3 tokenizer (128k BPE). Token counts are exact. Falls back to a heuristic estimate if the tokenizer is unavailable.',
    models: {
      'deepseek-v3-flash': {
